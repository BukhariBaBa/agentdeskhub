      ...
      return React.createElement(
        "div",
        {
          ...
          style: {
            display: "flex",
            gap: 14,
            paddingBottom: i === milestones.length - 1 ? 0 : 20,
            position: "relative",
          },
        },
            ...
            : active
              ? React.createElement("span", {
                  style: {
                    ...
                    animation: "ad-pulse-dot 1.6s ease-in-out infinite",
                  },
                })
              : React.createElement("span", {
                  style: {
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          "strong",
          null,
          pr.scopeCreep.requested.toLowerCase(),
        ),
        ", which is outside the original proposal. Draft a scope change notice?",
      ),
      React.createElement(
        "div",
        ...
        React.createElement(
          Button,
          {
            ...
            icon: "penTool",
            onClick: () => {
              const run = app.runChangeNotice(pr);
              app.openApproval(run.id);
            },
          },
          "Draft Change Notice",
        ),
        React.createElement(
          Button,
          {
            size: "sm",
            variant: "ghost",
            onClick: () => app.dismissScopeCreep(pr.id),
          },
          "Dismiss",
        ),
      ),
...
function TimeLogSection({ pr, app }) {
  ...
  const billableTotal = logs
    .filter((l) => l.billable)
    .reduce((s, l) => s + l.hours, 0);
  const submit = () => {
    const h = parseFloat(hours);
    if (!h || !desc.trim()) return;
    app.addTimeLog(pr.id, { date, hours: h, desc: desc.trim(), billable });
    setHours("");
    setDesc("");
    setAdding(false);
  };
    ...
    React.createElement(
      ...
      adding &&
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              Button,
              { size: "sm", variant: "primary", onClick: submit },
              "Add entry",
            ),
          ),
        ),
      logs.length
            ...
            React.createElement(
              "div",
              {
                ...
                style: {
                  ...
                  padding: "11px 14px",
                  borderBottom:
                    i === logs.length - 1 ? "none" : "1px solid var(--border)",
                },
              },
              React.createElement(
                "span",
              ...
              React.createElement(
                "button",
                {
                  onClick: () => app.toggleBillable(pr.id, l.id),
                ...
                React.createElement(
                  Badge,
                  { tint: l.billable ? "emerald" : "zinc", size: "sm" },
        ...
        : React.createElement(
            "div",
            {
              style: { padding: 16, fontSize: 13, color: "var(--text-subtle)" },
            },
            "No time logged yet.",
          ),
    ),
    logs.length
      ? React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(Icon, { name: "receipt", size: 13 }),
            "Finance Agent bills from these",
          ),
        )
      : null,
  );
    ...
    React.createElement(
      "div",
      {
        style: {
          ...
          alignItems: "center",
          justifyContent: "space-between",
          marginBottom: pr.weeklyUpdates ? 12 : 0,
        },
      },
      React.createElement(
        "div",
        ...
        React.createElement(
          ...
          pr.weeklyUpdates ? "Auto-drafted every " + pr.weeklyDay : "Paused",
        ),
      ),
      React.createElement(
        "button",
        {
          onClick: () => app.setWeeklyUpdates(pr.id, !pr.weeklyUpdates),
          style: {
            width: 40,
            height: 23,
            borderRadius: 99,
            ...
            cursor: "pointer",
            padding: 2,
            background: pr.weeklyUpdates
              ? "var(--indigo-600)"
              : "var(--zinc-300)",
            display: "flex",
            justifyContent: pr.weeklyUpdates ? "flex-end" : "flex-start",
          },
        },
        React.createElement("span", {
          style: {
    ...
    pr.weeklyUpdates &&
      React.createElement(
        ...
        React.createElement(
          ...
          {
            value: pr.weeklyDay,
            onChange: (e) => app.setWeeklyUpdates(pr.id, true, e.target.value),
            style: {
              flex: 1,
              padding: "7px 10px",
              border: "1px solid var(--border-strong)",
        ...
        React.createElement(
          Button,
          {
            ...
            icon: "send",
            onClick: () => {
              const run = app.runWeeklyUpdate(pr);
              app.openApproval(run.id);
            },
          },
          "Draft now",
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(Icon, { name: "listChecks", size: 19 }),
      ),
      React.createElement(
        "div",
        null,
        ...
        React.createElement(
          ...
          "Project Manager extracts requirements, budget, and action items.",
        ),
      ),
    ),
    React.createElement(
      ...
      React.createElement(
        "div",
        {
          style: { fontSize: 11.5, color: "var(--text-subtle)", marginTop: 6 },
        },
        "Leave blank to use a sample transcript for this demo.",
      ),
    ),
    React.createElement(
      "div",
...
function ProjectsView({ app }) {
  ...
  return React.createElement(
    ...
    React.createElement(PageHeader, {
      title: "Projects",
      subtitle:
        app.projects.filter((p) => p.status === "Active").length +
        " active · " +
        app.projects.filter((p) => p.status === "Complete").length +
        " complete",
    ...
    React.createElement(
      DataTable,
      {
        columns: [
          ...
          { label: "Client" },
          { label: "Status" },
          { label: "Deadline", right: true },
          { label: "Progress", w: 160 },
        ],
      },
      app.projects.map((p) => {
        ...
        return React.createElement(
          Row,
          { key: p.id, onClick: () => app.go("projects", { id: p.id }) },
          React.createElement(
            Td,
            null,
            React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(ProgressBar, {
                  ...
                  tint: p.status === "Complete" ? "emerald" : "indigo",
                }),
              ),
              React.createElement(
                "span",
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          pr.client + " · " + pr.start + " → " + pr.deadline,
        ),
      ),
      React.createElement(
        "div",
        ...
        React.createElement(
          Button,
          {
            ...
            icon: "link",
            onClick: () => {
              const c = app.clients.find((x) => x.company === pr.client);
              app.copyPortal(c || { company: pr.client });
            },
          },
          "Share with Client",
        ),
      ...
      "div",
      {
        style: {
          ...
          gridTemplateColumns:
            app.layout === "mobile"
              ? "1fr"
              : "minmax(0,1.5fr) minmax(250px,1fr)",
          gap: 18,
          alignItems: "start",
        },
      },
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            Card,
            { pad: 22 },
            React.createElement(MilestoneTimeline, {
              ...
              ? pr.files.map((f, i) =>
                  React.createElement(
                    "div",
                    {
                      ...
                      onClick: () =>
                        app.toast("Downloading " + f, { icon: "download" }),
                    },
                    React.createElement(
                      "span",
                      {
          ...
          React.createElement(
            ...
            React.createElement(
              Card,
              {
                pad: 16,
                hover: true,
                onClick: () => app.go("invoices", { id: inv.id }),
              },
              React.createElement(
                "div",
                {

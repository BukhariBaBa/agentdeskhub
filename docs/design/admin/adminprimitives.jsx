...
function AStatus({ value }) {
  return React.createElement(
    Badge,
    { tint: ADMIN_STATUS_TINT[value] || "zinc", dot: true, size: "sm" },
    value,
  );
}
  ...
  return React.createElement(
        ...
        React.createElement(
          "span",
          {
            style: {
              ...
              fontSize: 12,
              fontWeight: 600,
              color: TINT[dtint].solid,
            },
          },
          React.createElement(Icon, {
            name: up ? "trendingUp" : "trendingDown",
            size: 13,
            strokeWidth: 2.2,
          }),
          Math.abs(delta) + "%",
    ...
    sub &&
      React.createElement(
        "div",
        {
          style: { fontSize: 11.5, color: "var(--text-subtle)", marginTop: 4 },
        },
        sub,
      ),
  );
        ...
        return React.createElement(
          ...
          React.createElement("div", {
            style: {
              ...
              background:
                i === data.length - 1 ? TINT[tint].solid : TINT[tint].br,

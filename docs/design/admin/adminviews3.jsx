...
function PaymentsScreen({ admin }) {
  ...
  const rows = ADMIN_PAYMENTS.filter(
    (p) => plan === "All plans" || p.plan === plan,
  );
  const total = rows
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          rows.length + " transactions · " + money(total) + " collected",
        ),
      ),
      React.createElement(
        Button,
        {
          ...
          icon: "download",
          onClick: () =>
            admin.toast("Exported " + rows.length + " rows to CSV", "download"),
        },
        "Export CSV",
      ),
    ),
    ...
    React.createElement(
      ...
      {
        title: "Gross revenue",
        sub: "Monthly · last 6 months",
        style: { marginBottom: 16 },
        action: React.createElement(
          Badge,
          { tint: "emerald", size: "sm", dot: true },
          fmtK(REVENUE_6M_BARS[REVENUE_6M_BARS.length - 1].v),
        ),
      },
      React.createElement(BarChart, {
        data: REVENUE_6M_BARS,
        height: 140,
        tint: "emerald",
        labelEvery: 1,
        fmt: fmtK,
    ...
    React.createElement(
      ...
      React.createElement(MiniSelect, {
        value: range,
        onChange: setRange,
        options: ["This month", "Last month", "Last 3 months", "Year to date"],
        width: 150,
      }),
      React.createElement(MiniSelect, {
        value: plan,
        onChange: setPlan,
        options: ["All plans", "Starter", "Pro", "Agency"],
        width: 130,
      }),
    ),
    ...
    React.createElement(
      ATable,
      {
        ...
        columns: [
          ...
          { label: "Workspace" },
          { label: "Plan", w: 100 },
          { label: "Amount", right: true, w: 110 },
          { label: "Status", right: true, w: 120 },
        ],
      },
      rows.map((p) =>
        React.createElement(
          ...
          React.createElement(
            ACell,
            { right: true, mono: true, bold: true },
            money(p.amount),
          ),
          React.createElement(
            ACell,
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        "Every agent run across all workspaces · click a row to inspect the payload",
      ),
    ),
    ...
    React.createElement(
      ...
      React.createElement(MiniSelect, {
        value: agent,
        onChange: setAgent,
        options: ["All agents", ...AGENT_TYPES],
        width: 160,
      }),
      React.createElement(
        "div",
    ...
    React.createElement(
      ATable,
      {
        minWidth: 860,
        columns: [
          { label: "Timestamp", w: 150 },
          { label: "Workspace" },
          { label: "Agent", w: 140 },
          { label: "Status", w: 100 },
          { label: "Tokens", right: true, w: 90 },
          { label: "Model", w: 130 },
          { label: "Duration", right: true, w: 90 },
        ],
      },
      runs.map((r) =>
        React.createElement(
          ...
          React.createElement(
            ACell,
            { mono: true, color: "var(--text-subtle)", nowrap: true },
            r.ts,
          ),
          ...
          React.createElement(
            ACell,
            { mono: true, color: "var(--text-muted)" },
            r.model,
          ),
          React.createElement(
            ACell,
            { right: true, mono: true, color: "var(--text-muted)" },
            r.duration,
          ),
        ),
      ),
    ...
    React.createElement(
      Drawer,
      { open: !!current, onClose: () => setActive(null), width: 600 },
      current &&
...
function RunDetail({ run, onClose }) {
  const payloadBox = (label, text, error) =>
    React.createElement(
      "div",
      ...
      React.createElement(
        "pre",
        {
          style: {
            margin: 0,
            padding: "13px 15px",
            background: error ? "var(--rose-50)" : "var(--zinc-950)",
            color: error ? "var(--rose-700)" : "var(--zinc-100)",
            border: error ? "1px solid var(--rose-100)" : "none",
            borderRadius: "var(--r-md)",
            fontFamily: "var(--mono)",
            fontSize: 12,
            lineHeight: 1.6,
  ...
  return React.createElement(
    ...
    React.createElement(DrawerHead, {
      ...
      sub: run.id + " · " + run.ts,
      onClose,
      badge: React.createElement(AStatus, { value: run.status }),
    }),
    React.createElement(
      "div",
      ...
      React.createElement(
        ...
        [
          ...
          React.createElement(
            "div",
            { key: i, style: { background: "#fff", padding: "11px 13px" } },
            React.createElement(
              "div",
              {
                style: {
      ...
      React.createElement(
        ...
        "Debug view · payloads are read-only and access is logged to the audit trail.",
      ),
    ),
  );
}
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          "Broadcast to the in-app notification bell · " +
            items.length +
            " sent",
        ),
      ),
      React.createElement(
        Button,
        { variant: "primary", icon: "plus", onClick: () => setComposing(true) },
        "New Announcement",
      ),
    ),
        ...
        React.createElement(
            ...
            React.createElement(
              Badge,
              {
                tint:
                  a.target === "All users"
                    ? "indigo"
                    : a.target.includes("Pro")
                      ? "indigo"
                      : a.target.includes("Agency")
                        ? "emerald"
                        : "zinc",
                size: "sm",
              },
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              React.createElement(
                "div",
                { style: { fontWeight: 600, fontSize: 12.5, marginBottom: 2 } },
                a.title,
              ),
              React.createElement(
                "div",
    ...
    React.createElement(ComposeModal, {
      ...
      onSend: (a) => {
        ...
        admin.act("Sent announcement", a.target + ' · "' + a.title + '"');
      },
    }),
  );
}
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          ["All users", "Starter only", "Pro only", "Agency only"].map((t) =>
            React.createElement(
              "button",
              {
                key: t,
                ...
                style: {
                  ...
                  fontWeight: 550,
                  cursor: "pointer",
                  background: target === t ? "var(--indigo-50)" : "#fff",
                  color:
                    target === t ? "var(--indigo-700)" : "var(--text-muted)",
                  border:
                    "1px solid " +
                    (target === t
                      ? "var(--indigo-200)"
      ...
      React.createElement(BellPreview, {
        title: title || "Your announcement title",
        message:
          message ||
          "This is how your message appears in the notification bell.",
        target,
      }),
    ),
    React.createElement(
...
function BellPreview({ title, message, target }) {
  return React.createElement(
    ...
    React.createElement(
      "div",
      { style: { padding: 13, display: "flex", gap: 11, background: "#fff" } },
      React.createElement(
        "span",
        {
          style: {

...
const PORTAL_PROPOSALS = [
  ...
  {
    id: "pp2",
    title: "Wholesale Packaging Design",
    status: "Sent",
    date: "Jun 2",
    recommended: "Standard",
    intro:
      "Label and bag design for your new wholesale line. Pick the option that fits — I’d suggest Standard for the three-SKU launch.",
    tiers: [
      {
        name: "Basic",
        price: 1800,
        delivery: "1 week",
        scope: "Label design for a single hero SKU.",
        includes: ["1 label design", "Print-ready file", "1 revision round"],
      },
      {
        name: "Standard",
        price: 3200,
        delivery: "2 weeks",
        scope: "Full three-SKU label & bag system.",
        includes: [
          "3 origin labels",
          "Bag + box artwork",
          "Print spec sheet",
      ...
      },
      {
        ...
        price: 5400,
        delivery: "3 weeks",
        scope: "Packaging system plus retail display.",
        includes: [
          "Everything in Standard",
          "Shelf display design",
          "Seasonal label template",
...
const PORTAL_PROJECT = {
  name: "Brand & Website",
  desc: "Full brand refresh and a 6-page website for your second-location launch.",
  start: "May 19",
  deadline: "Jun 30",
  daysLeft: 26,
  milestones: [
  ...
  files: [
    { name: "Lumen Brand Guide.pdf", size: "4.2 MB" },
    { name: "Logo Pack.zip", size: "1.1 MB" },
  ],
};
...
const PORTAL_INVOICES = [
  {
    num: "INV-004",
    desc: "Brand & website — 50% milestone",
    amount: 6250,
    due: "Jun 10",
    status: "Sent",
    items: [
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          {
            onClick: exit,
            title: "Exit portal preview (demo only)",
            style: {
              display: "inline-flex",
              alignItems: "center",
              gap: 6,
          ...
          React.createElement(Icon, { name: "chevronLeft", size: 13 }),
          "Back to dashboard",
        ),
      ),
      // tabs
          ...
          React.createElement(
            "button",
            {
              ...
              style: {
                ...
                borderBottom:
                  "2px solid " +
                  (tab === t ? "var(--zinc-900)" : "transparent"),
                color: tab === t ? "var(--zinc-900)" : "var(--text-muted)",
                fontSize: 13.5,
      ...
      return React.createElement(
        "div",
        {
          ...
          style: {
            display: "flex",
            gap: 13,
            paddingBottom: i === milestones.length - 1 ? 0 : 18,
            position: "relative",
          },
        },
        i < milestones.length - 1 &&
          React.createElement("div", {
            style: {
              ...
              bottom: 0,
              width: 2,
              background: done ? "#A7F3D0" : "var(--border)",
            },
          }),
        React.createElement(
          "span",
          {
            style: {
              ...
              justifyContent: "center",
              fontSize: 14,
              background: done ? "var(--emerald-500)" : "#fff",
              border:
                "2px solid " +
                (done
                  ? "var(--emerald-500)"
        ...
        React.createElement(
          ...
          React.createElement(
            "div",
            {
              style: {
                fontSize: 12.5,
                color: active ? "var(--zinc-900)" : "var(--text-subtle)",
                marginTop: 2,
  ...
  return React.createElement(
    "div",
    {
      ...
      style: {
        ...
        opacity: dim ? 0.5 : 1,
        boxShadow: selected || isAcc ? "0 0 0 1px " + border : "none",
    ...
    (rec || isAcc) &&
      React.createElement(
        ...
        {
          style: {
            background: isAcc ? "var(--emerald-500)" : "var(--zinc-900)",
            color: "#fff",
            fontSize: 10.5,
            fontWeight: 600,
            textTransform: "uppercase",
          ...
          React.createElement(
            "span",
            {
              style: {
                ...
                border:
                  "1.5px solid " +
                  (selected ? "var(--zinc-900)" : "var(--border-strong)"),
                background: selected ? "var(--zinc-900)" : "#fff",
                display: "inline-flex",
                alignItems: "center",
                justifyContent: "center",
              },
...
function TestimonialCard({ app, company }) {
  ...
  if (done)
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(Icon, { name: "checkCircle", size: 18 }),
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(PStars, { n: stars, onSet: setStars }),
    ),
    React.createElement("textarea", {
      value: text,
      onChange: (e) => setText(e.target.value),
      placeholder: "Share a sentence about your experience (optional)…",
      rows: 3,
      style: {
        width: "100%",
        padding: "11px 13px",
    ...
    React.createElement(
      ...
      React.createElement(
        Button,
        {
          ...
          onClick: () => {
            app.addTestimonial({
              client: PORTAL_CLIENT.contact + " @ " + company,
              company,
              stars,
              text: text.trim() || "Loved working with Rivera Studio.",
              date: "Jun 2026",
            });
            setDone(true);
            app.toast("Testimonial submitted — thank you!", {
              icon: "checkCircle",
              tint: "emerald",
            });
          },
...
function PortalView({ app, exit }) {
  ...
  const acceptProp = (p) => {
    ...
    setProposals((ps) =>
      ps.map((x) =>
        x.id === p.id
          ? { ...x, status: "Accepted", date: "Jun 4", acceptedTier: chosen }
          : x,
      ),
    );
    setOpenProp(null);
    app.toast(
      "Proposal accepted" +
        (chosen ? " — " + chosen + " tier" : "") +
        ". Thank you!",
      { icon: "checkCircle", tint: "emerald" },
    );
  };
  const payInvoice = (num) => {
    setInvoices((iv) =>
      iv.map((x) =>
        x.num === num ? { ...x, status: "Paid", paid: "Jun 4" } : x,
      ),
    );
    setJustPaid(true);
    setOpenInv(null);
  ...
  const sendMsg = () => {
    ...
    setSent(true);
    setMsg("");
    app.toast("Message sent to Rivera Studio", {
      icon: "send",
      tint: "emerald",
    });
  ...
  const propAmount = (p) =>
    p.tiers
      ? p.acceptedTier
        ? p.tiers.find((t) => t.name === p.acceptedTier).price
        : p.tiers.find((t) => t.name === p.recommended).price
      : p.amount;
  ...
  return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            "Welcome back, " + PORTAL_CLIENT.company,
          ),
          React.createElement(
            "p",
            {
            ...
            "Everything for our project in one place — progress, deliverables, and invoices. Reach out anytime.",
          ),
        ),
        justPaid &&
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              ...
              PORTAL_PROJECT.daysLeft + " days left",
            ),
          ),
          React.createElement(
            "div",
            { style: { fontSize: 17, fontWeight: 650, marginBottom: 4 } },
            PORTAL_PROJECT.name,
          ),
          React.createElement(
            "div",
            ...
            "Due " + PORTAL_PROJECT.deadline,
          ),
          (() => {
            const done = PORTAL_PROJECT.milestones.filter(
              (m) => m.status === "complete",
            ).length;
            const pct = (done / PORTAL_PROJECT.milestones.length) * 100;
            return React.createElement(
              "div",
              null,
              React.createElement(
                ...
                React.createElement(
                  ...
                  { style: { color: "var(--text-muted)" } },
                    ...
                    " of " +
                    PORTAL_PROJECT.milestones.length +
                    " milestones complete",
                ),
                React.createElement(
                  "span",
            ...
            React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  money(latestInv.amount),
                ),
                React.createElement(
                  Badge,
                  { status: latestInv.status, dot: true },
            ...
            React.createElement(
              ...
              latestInv.status !== "Paid" &&
                React.createElement(
                  ...
                  {
                    variant: "success",
                    onClick: () => payInvoice(latestInv.num),
                  },
                  "Pay Now",
                ),
              React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            [
              {
                t: "Milestone “Brand identity & guide” completed",
                d: "May 30",
              },
        ...
        React.createElement(
          ...
          sent
            ? React.createElement(
                ...
                React.createElement(Icon, { name: "checkCircle", size: 18 }),
                "Thanks — Jordan will get back to you shortly.",
              )
            : React.createElement(
                "div",
                null,
                ...
                React.createElement(
                  ...
                  React.createElement(
                    Button,
                    { variant: "primary", icon: "send", onClick: sendMsg },
                    "Send message",
                  ),
                ),
              ),
    ...
    tab === "Proposals" &&
      (openProp
        ? (() => {
            const p = proposals.find((x) => x.id === openProp);
            const chosen = selTier[p.id] || p.recommended;
            return React.createElement(
              "div",
              null,
              React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    Badge,
                    { status: p.status, dot: true },
                    p.status === "Accepted" ? "Accepted " + p.date : p.status,
                  ),
                ),
                p.status === "Accepted" &&
                  React.createElement(
                    ...
                    p.acceptedTier
                      ? "You accepted the " +
                          p.acceptedTier +
                          " option — thank you!"
                      : "You accepted this proposal — thank you!",
                  ),
                p.tiers
                  ? React.createElement(
                      "div",
                      ...
                      React.createElement(
                        "div",
                        {
                          style: {
                            display: "grid",
                            gridTemplateColumns:
                              app.layout === "mobile" ? "1fr" : "repeat(3,1fr)",
                            gap: 12,
                          },
                        },
                        p.tiers.map((t, i) =>
                          React.createElement(PTierCard, {
                            key: i,
                            tier: t,
                            recommended: p.recommended,
                            selected: p.status === "Sent" && chosen === t.name,
                            accepted: p.acceptedTier,
                            selectable: p.status === "Sent",
                            onSelect: () =>
                              setSelTier((s) => ({ ...s, [p.id]: t.name })),
                          }),
                        ),
                      ),
                    )
                  ...
                  React.createElement(
                    ...
                    React.createElement(
                      Button,
                      {
                        ...
                        size: "lg",
                        icon: "check",
                        onClick: () => acceptProp(p),
                      },
                      p.tiers
                        ? "Accept " +
                            chosen +
                            " — " +
                            money(p.tiers.find((t) => t.name === chosen).price)
                        : "Accept Proposal",
                    ),
                    React.createElement(
                      Button,
                      {
                        ...
                        size: "lg",
                        onClick: () =>
                          app.toast("Change request sent to Rivera Studio", {
                            icon: "message",
                            tint: "amber",
                          }),
                      },
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              "span",
              null,
              "Started " + PORTAL_PROJECT.start,
            ),
            React.createElement("span", null, "Due " + PORTAL_PROJECT.deadline),
          ),
        ),
        React.createElement(
          PCard,
          null,
          React.createElement(PLabel, null, "Milestones"),
          React.createElement(PortalMilestones, {
            milestones: PORTAL_PROJECT.milestones,
          }),
        ),
        React.createElement(
          PCard,
          null,
          React.createElement(PLabel, null, "Deliverables"),
          React.createElement(
            "div",
            { style: { display: "flex", flexDirection: "column", gap: 8 } },
            PORTAL_PROJECT.files.map((f, i) =>
              React.createElement(
                "div",
                {
                  key: i,
                  onClick: () =>
                    app.toast("Downloading " + f.name + "…", {
                      icon: "download",
                    }),
                  style: {
                    display: "flex",
                ...
                React.createElement(
                  ...
                  React.createElement(Icon, { name: "proposals", size: 16 }),
                ),
                React.createElement(
                  "div",
                  { style: { flex: 1 } },
    ...
    tab === "Invoices" &&
      (openInv
        ? (() => {
            const iv = invoices.find((x) => x.num === openInv);
            const subtotal = iv.items.reduce(
            ...
            return React.createElement(
              ...
              React.createElement(
                ...
                React.createElement(
                  ...
                  React.createElement(
                    Badge,
                    { status: iv.status, dot: true },
                    iv.status === "Paid" ? "Paid " + iv.paid : iv.status,
                  ),
                ),
                React.createElement(
                  "table",
